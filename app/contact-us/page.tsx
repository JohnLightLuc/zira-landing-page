      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-10">
          ...
          <div className="flex items-center gap-3 mb-3">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--blue-3)" strokeWidth={1.8}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
              </svg>
            </div>
            <h1
              className="text-2xl font-bold"
              style={{ color: "var(--white-fleet)", fontFamily: "'Space Grotesk', sans-serif", letterSpacing: "-0.6px" }}
            >
              Nous contacter
            </h1>
          </div>
          <p className="text-sm" style={{ color: "var(--slate-2)" }}>
            Une question, un projet, un besoin de support ? Notre équipe vous répond sous 24 h.
          </p>
        </div>
        ...
        {submitted ? (
          ...
          >
            ...
            <button
              ...
              style={{ background: "var(--blue)", color: "#fff", fontFamily: "'Space Grotesk', sans-serif" }}
            >
              Nouveau message
            </button>
          </div>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium" style={{ color: "var(--slate-2)" }}>
              ...
              <div className="flex flex-col gap-1.5">
                <label className="text-xs font-medium" style={{ color: "var(--slate-2)" }}>
                  Adresse e-mail <span style={{ color: "var(--blue-3)" }}>*</span>
                </label>
                <input
                  type="email"
                  name="email"
            ...
            <div className="flex flex-col gap-1.5">
              ...
              >
                ...
                {subjects.map((s) => (
                  <option key={s} value={s} style={{ background: "var(--navy-2)", color: "var(--white-fleet)" }}>
                    {s}
                  </option>
                ))}
              </select>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-1">
              <p className="text-xs" style={{ color: "var(--slate)" }}>
                Réponse garantie sous 24 h ouvrées · contact@fleettrack.io
              </p>
              <button
                type="submit"
                disabled={loading}
        ...
        <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { icon: "M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75", label: "E-mail", value: "contact@fleettrack.io" },
            { icon: "M9 3.75H6.912a2.25 2.25 0 00-2.15 1.588L2.35 13.177a2.25 2.25 0 00-.1.661V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-4.162c0-.224-.034-.447-.1-.661L19.24 5.338a2.25 2.25 0 00-2.15-1.588H15M2.25 13.5h3.86a2.25 2.25 0 012.012 1.244l.256.512a2.25 2.25 0 002.013 1.244h3.218a2.25 2.25 0 002.013-1.244l.256-.512a2.25 2.25 0 012.013-1.244h3.859M12 3v8.25m0 0l-3-3m3 3l3-3", label: "Support", value: "support@fleettrack.io" },
            { icon: "M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z", label: "Disponibilité", value: "Lun – Ven · 9h – 18h" },
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--blue-3)" strokeWidth={1.8}>
                <path strokeLinecap="round" strokeLinejoin="round" d={icon} />
              </svg>
              <span className="text-xs font-medium" style={{ color: "var(--slate)" }}>{label}</span>
              <span className="text-xs font-semibold" style={{ color: "var(--white-2)" }}>{value}</span>
            </div>
          ))}
        </div>
      </main>
